from django.contrib.auth.models import User  # lint-amnesty, pylint: disable=imported-auth-user, missing-module-docstring  # lint-amnesty, pylint: disable=missing-module-docstring
